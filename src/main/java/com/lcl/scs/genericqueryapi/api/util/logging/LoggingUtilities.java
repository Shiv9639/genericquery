package com.lcl.scs.genericqueryapi.api.util.logging;
...
public class LoggingUtilities {
	...
	/*
	 * public static void generateValidationLog(Exception exception, String message,
	 * String validationDetails, String actionBy, String api) {
	 * logger.info(ScvUtilities.appendNewLines("API: " + api, message,
	 * "Validation Details " + validationDetails, "Action By " + actionBy)); }
	 * 
	 * public static void generateValidationLog(Exception exception, String message,
	 * String validationDetails, String api) {
	 * logger.info(ScvUtilities.appendNewLines("API: " + api, message,
	...
	public static void generateErrorLog(Exception exception, String actionBy, String transactionId) {
		getLogger().error(generateMessage(exception == null ? null : exception.getMessage(), actionBy, transactionId),
				exception);
	}
	...
	public static void generateErrorLog(String message, Exception exception) {
		getLogger().error(generateMessage(message));
		getLogger().error(generateMessage(exception == null ? null : exception.getMessage()));
	}

	public static void generateErrorLog(Exception exception,String message) {
		getLogger().error(generateMessage(message));
		getLogger().error(generateMessage(exception == null ? null : exception.getMessage()));
	}
	...
	private static String generateMessage(String message, String actionBy, String transactionId) {
		if (actionBy != null) {
			return new StringBuffer().append("Message:").append(message).append(", actionBy:").append(actionBy)
